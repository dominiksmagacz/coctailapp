                        ...
                        <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                <div class="overflow-hidden ring-black ring-opacity-5 md:rounded-lg">
                                    <form action="{{ route('posts.store') }}" method="POST" id="create_post" enctype="multipart/form-data">
                                        @csrf
                                        {{ __('Nazwa przepisu') }}
                                        <br />
                                        <div
                                        ...
                                        <br />
                                        <div class="col-md-6">
                                            <input type="file" accept="image/*,.pdf" name="image_path" class="form-control">
                                        </div>
                                        <br />
